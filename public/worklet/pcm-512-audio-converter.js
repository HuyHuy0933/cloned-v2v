class PCM512AudioConverter extends AudioWorkletProcessor {
  constructor() {
    super();

    console.log("load pcm 512 audio converter processor")
    this.bufferSize = 512; // Desired buffer size
...
registerProcessor("pcm-512-audio-converter", PCM512AudioConverter);
